function renderChart(id, hidden){
    ...
    if (hidden) {
        ...
        document.write(`<iframe class="b-lazy" id="datawrapper-chart-${id}" data-src="https://datawrapper.dwcdn.net/${id}" scrolling="no" frameborder="0" style="width: 0; min-width: 100% !important; border: none;" height="400"></iframe>`)
    }
